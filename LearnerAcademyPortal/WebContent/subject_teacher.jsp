            ...
            <div style="margin:20px;">
               <%--<h3><%= var %></h3>--%>
                <div id="left">
                    <h2></h2>
                    <fieldset>
                        <legend>Add assigned teacher details :-</legend>
                    <form action="addsubteacher"><table align='center' >
                        <tr>
                ...
                <div id="right">
                    <h2 style="margin:0px">Existing Assigned Teacher details:-</h2>
                    <table border="1" align="center" width="100%">
                        <tr>
                            <td style="background-color: lightgray">ID</td>
                            <td style="background-color: lightgray">Class</td>
                            <td style="background-color: lightgray">Subject</td>
                            <td style="background-color: lightgray">Teacher</td>
                        ...
                        <% 
                            ...
                            ResultSet rs=st.executeQuery("select * from class_sub_teacher_master");
                            while(rs.next()){
                        %>
                        <tr>
                            <td><%= rs.getInt(1) %></td>
                            ...
                            <% 
                            Connection con6=DBConnection.dbCon();
                            PreparedStatement st6=con6.prepareStatement("select firstname from teachermaster where tid=?");
                            st6.setInt(1, rs.getInt(4));
                            ResultSet rs6=st6.executeQuery();
                            rs6.next();
                            %>
                            <td><%= rs6.getString(1) %></td>
                            
                            <td><a href='EditSubTeacher.jsp?sub_cls_id=<%= rs.getInt(1)%>'><img src='images/update.jpg' height='40' width='40' /></a></td>
                            <td><a href='deletesubteacher?sub_cls_id=<%= rs.getInt(1)%>'><img src='images/delete.jpg' height='40' width='40' /></a></td>
                        </tr>
                        <%
                            }
                            con.close();
